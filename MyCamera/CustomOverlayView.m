...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        // Add the bottom bar                
        CGRect frame = CGRectMake(0, self.bounds.size.height - 75, 320, 75);
        ...
        self.pictureButton.frame = CGRectMake(90, self.bounds.size.height - 75, 130, 100);
        ...
        self.lastPicture.frame = CGRectMake(20, self.bounds.size.height - 50, 50, 50);
